...
def main():
    ...
    # rx_data = go.Scattermapbox(lon=[geo['rx_lat']],
    #                         lat=[geo['rx_lon']],
    #                         text = "RX",
    #                         mode = "markers",
    #                         marker=dict(
    ...
    rx_scatter.data[0]['marker']=dict(color='red', size=15, opacity=1.0)  #this works
    #rx_scatter.data[0]['marker']=dict(size=5, symbol='airfield')
    rx_scatter.data[0]['hovertemplate']='<b>%{hovertext}</b>'
    #rx_scatter.data[0]['marker']=dict(size=15, symbol='square')  #this works
